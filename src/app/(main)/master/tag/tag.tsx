...
const TagForm: React.FC = () => {
  ...
  const handleAddTag = async (e: React.FormEvent | React.MouseEvent) => {
    ...
    try {
      ...
      setSuccessMessage(`Tag "${tagName}" added successfully!`);
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                disabled={isLoading}
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors ${error ? 'border-red-300 bg-red-50' : 'border-gray-300'
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 px-6 py-3 rounded-md font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 ${isLoading || !currentTag.trim()
